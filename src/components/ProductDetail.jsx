...
const ProductDetail = ({ match: { params = {} } }) => {
  ...
  if (!selectedProduct) {
    return <h2 className="text-danger text-center mt-3">Product not found</h2>;
  }

  return (
    <div>
      <h1 className="text-danger">{selectedProduct.title}</h1>
      <img src={selectedProduct.img_src} alt={selectedProduct.title} />
